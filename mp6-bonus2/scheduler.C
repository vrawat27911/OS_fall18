...
void Scheduler::yield() 
{
    ...
    else
    {
        ...
        Console::puts("Yield thread \n");
        Console::puti(deque_t->ThreadId()); Console::puts("Yield thread \n");
...
void Scheduler::resume(Thread * _thread)
{
    ...
    // Console::puti(_thread->ThreadId()); Console::puts("Resume thread \n");
